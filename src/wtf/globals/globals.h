...
struct MasterOptions_t {
  ...
  //
  // Binary name to get instructions number from.
  //

  std::string BinaryName;

  //
  // The minimum size of a generated testcase.
  //

  uint64_t TestcaseBufferMinSize = 0;
  ...
  //
  //  Path to the diffs directory.
  //

  fs::path DiffsPath;

  //
  // Tell if we should create diff files or not.
  //

  bool CreateDiffs = false;
...
struct Options_t {
  ...
  //
  // Turn on a full trace generation.
  //
